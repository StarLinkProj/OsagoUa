<?php
/**------------------------------------------------------------------------
# plg_socbuttons - Social Share Buttons Plugin Content for Joomla 3.0
# author    tallib
# copyright - Copyright (C) 2013 SocExt.com. All Rights Reserved.
# @license - http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
# Websites: http://SocExt.com
# Technical Support:  Joomla Blog - http://socext.com
-------------------------------------------------------------------------**/
/**------------------------------------------------------------------------
* file: socbuttons.php 1.5.0, February 2013 20:00:00 tallib $
	...
	{	
        ...
        $link = $root.$link;
			...
			if($this->params->get('Vk')==1){
                ...
                $html .='<script type="text/javascript">VK.Widgets.Like("vk_like'.$row->id.'", {type: "button", height: 20});</script>'; 
				$html .= '</div>';
			}else{
				$html .='';
			}
			...
			$website_name = $config->get('sitename');
			$document->addCustomTag('<meta property="og:site_name" content="'.$website_name.'"/>');
			...
			$document->addCustomTag('<meta property="og:url" content="'.$link.'"/>');
				$html .= '<div style="margin-left: 60px; width: '.$this->params->get('fblike_width').'px; height :'.$heighttype.'px; float: left;">';
			...
			$html .= '<div class="'.$soc_copr.'"><a href="http://nauca.com.ua/plugins/socbuttons-v16/" title="Social buttons" target="_blank">Social buttons</a></div>';
			$html .= '</div>';
			$html .= '<div style="clear:both;"></div>';
			//end plugin
