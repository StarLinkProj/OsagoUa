...
<h1 class="smfaq">Часто задаваемые вопросы</h1>
<div class="faq-block">
...
<span class="mod-button">Задать свой вопрос</span>
...
if ($canCreate && !$canEdit) :
	if ($this->params->get('show_form', 0) && isset($this->form)) : ?>
		<?php echo $this->form; ?>
	<?php else : ?>
		<span data-toggle="modal" data-target="#FAQModal" onclick="SmFaq.showform(true,this)" class="button"><?php echo JText::_('COM_SMFAQ_NEW_QUESTION'); ?></span>
<?php endif; ?>
<?php elseif ($canEdit) : ?>
	...
	<span class="button" style="display: block;" data-toggle="modal" data-target="#smfaq-form" onclick="SmFaq.unpublished(<?php echo JFactory::getApplication()->input->get('Itemid', null, 'int'); ?>)">
